...
In this model, we'll include the variables (avgsen, mix, central), as we think they will contribute to the accuracy of your results without introducing substantial bias. These variables show good degree of correlation with crime rate, as well as, linear relationship as observed in the EDA. 
...
Note that 'Density' coefficient drastically changes in model 3 because variables like 'Total Wage' and 'Log of Police per K'  distribute are synonymous to increase in density and they absorb some of the causality of density.
Similarly addition of '% of Minority' in model 3 reduces the effect of 'Is Western County' as western counties have very low minority population hence '% of Minority' absorbs some of the causal effect of west variable in model 3.
